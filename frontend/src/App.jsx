...
const DEFAULT_CITIES = [
  {
    ...
    name: 'Karachi',
    branches: [
      { id: 'khi-clifton', name: 'Clifton Block 4', phone: '0331-2152010', deliveryEtaMinutes: 35 },
      { id: 'khi-gulshan', name: 'Gulshan-e-Iqbal Block 13', phone: '0317-5563119', deliveryEtaMinutes: 40 },
      { id: 'khi-dha', name: 'DHA Phase 5 Badar Commercial', phone: '0309-4522103', deliveryEtaMinutes: 30 },
    ],
  },
  {
    id: 'lhr',
    name: 'Lahore',
    branches: [
      { id: 'lhr-gulberg', name: 'Gulberg III Main Boulevard', phone: '0333-7892556', deliveryEtaMinutes: 35 },
      { id: 'lhr-johar', name: 'Johar Town G-1 Market', phone: '0309-1195233', deliveryEtaMinutes: 40 },
    ],
  },
  {
    id: 'isb',
    name: 'Islamabad',
    branches: [
      { id: 'isb-f7', name: 'F-7 Markaz Jinnah Super', phone: '0309-2314446', deliveryEtaMinutes: 35 },
    ],
  },
];
